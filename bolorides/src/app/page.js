...
export default function HomePage() {
  ...
  return (
    <div className="h-screen w-full mx-0 px-0 flex flex-col">
      <div className="relative flex flex-col justify-center items-center p-6">
        <Image
          src={sliderImages[currentIndex]}
          alt={`Slider Image ${currentIndex + 1}`}
          layout="fill"
          objectFit="contain" // Changed to contain for small screens
          className="absolute inset-0 z-0"
        />
        <div className="absolute inset-0 bg-black opacity-50 z-10"></div> {/* Shadow Overlay */}
